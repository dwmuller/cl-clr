...
(deftest member-access ()
  (let ((obj1 (new '?ConcreteClass1))
    ...
    (check
      ...
      (equal "ConcreteClass1.MCS1()" (?.MCS1 '?ConcreteClass1))
      (equal "ConcreteClass1.PCS1" (?.PCS1 '?ConcreteClass1))
      (equal "ConcreteClass1.FCS1" (?.FCS1 '?ConcreteClass1))
      ...
      (equal "ConcreteClass1.MCS1()" (?.MCS1 '?TrivialDerivedClass1))
      (equal "ConcreteClass1.PCS1" (?.PCS1 '?TrivialDerivedClass1))
      (equal "ConcreteClass1.FCS1" (?.FCS1 '?TrivialDerivedClass1))
      ...
      (equal "ShadowingClass1.MCS1()" (?.MCS1 '?ShadowingClass1))
      (equal "ShadowingClass1.PCS1" (?.PCS1 '?ShadowingClass1))
      (equal "ShadowingClass1.FCS1" (?.FCS1 '?ShadowingClass1))
